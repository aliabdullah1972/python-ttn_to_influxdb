...
# InfluxDB settings
influx_url = "http://localhost:8086"         # InfluxDB URL, adjust if using InfluxDB Cloud
token = "cs9MoFJjRBdNI0XJn9DxjnpwnF_JovDK1EzptbBNzFid1IzMOCWOzpyTi32286eE8XaTfCLGIrT6aGdkLjmILg=="                # InfluxDB authentication token
org = "KIST"                             # InfluxDB organization name
bucket = "ttn"                       # InfluxDB bucket name
...
def on_connect(client, userdata, flags, rc):
    if rc == 0:
        ...
        client.subscribe(f"v3/{app_id}@ttn/devices/ali-dev1/up")
    else:
